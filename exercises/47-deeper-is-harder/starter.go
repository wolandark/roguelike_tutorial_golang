...
// spawnTable returns the merged weights by entity name that apply on floor. Your turn!
func spawnTable(chances map[int][]spawnChance, floor int) map[string]int {
	return nil
}
