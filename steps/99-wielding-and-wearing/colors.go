...
var (
	...
	colorInvalid    = tcell.NewRGBColor(0xFF, 0xFF, 0x00)
	colorImpossible = tcell.NewRGBColor(0x80, 0x80, 0x80)
	colorError      = tcell.NewRGBColor(0xFF, 0x40, 0x40)

	colorWelcomeText         = tcell.NewRGBColor(0x20, 0xA0, 0xFF)
	colorHealthRecovered     = tcell.NewRGBColor(0, 0xFF, 0)
	colorNeedsTarget         = tcell.NewRGBColor(0x3F, 0xFF, 0xFF)
	colorStatusEffectApplied = tcell.NewRGBColor(0x3F, 0xFF, 0x3F)

	colorDescend   = tcell.NewRGBColor(0x9F, 0x3F, 0xFF)
	colorMenuTitle = tcell.NewRGBColor(255, 255, 63)
