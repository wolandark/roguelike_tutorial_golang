...
var (
	floor = Tile{
		...
		Light: Glyph{' ', tcell.ColorWhite, tcell.NewRGBColor(200, 180, 50)},
	}
	wall = Tile{
		Walkable: false, Transparent: false,
		Dark:  Glyph{' ', tcell.ColorWhite, tcell.NewRGBColor(0, 0, 100)},
		Light: Glyph{' ', tcell.ColorWhite, tcell.NewRGBColor(130, 110, 50)},
	}
	downStairs = Tile{
		Walkable: true, Transparent: true,
		Dark:  Glyph{'>', tcell.NewRGBColor(0, 0, 100), tcell.NewRGBColor(50, 50, 150)},
		Light: Glyph{'>', tcell.ColorWhite, tcell.NewRGBColor(200, 180, 50)},
	}
)
